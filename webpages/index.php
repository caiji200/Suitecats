...
<html>
	...
	<body>
		...
		<content> 
			...
			<th><div id="lowered_div">
			<button id="icon_adoption"onclick= "window.location.href='adoption.php'"></button>
			<h2 class="labels">Adoption Center</h2></a></div></th>
			
			
			<th><div id="raised_div">
			<button id="icon_suite" onclick= "window.location.href='suite.php'"></button>
			<h2 class="labels">Suite</h2></a></div></th>
			
			
			<th><div id ="lowered_div">
			<button id="icon_marketplace" onclick= "window.location.href='marketplace.php'"></button>
